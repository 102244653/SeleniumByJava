...
public class TestFabricMySQLConnectionSharding extends BaseFabricTestCase {
    ...
    public void testGlobalTableCreation() throws Exception {
        ...
        // MyAssert other groups for table
        ResultSet rs;
        ...
        for (String groupName : groupsToTest) {
            ...
            assertTrue(rs.next()); // If test fails here, MyAssert replication wait above
    ...
    public void testShardSelection() throws Exception {
        ...
        // MyAssert data by shard selection
        ...
        assertFalse(rs.next());
        rs.close();
        // TODO MyAssert additional values

        // MyAssert data by group selection
        // TODO
