...
public class MetaDataRegressionTest extends BaseTestCase {
     ...
     * method also covers support for MyAssert constraints, which MySQL _doesn't_
     * have.
     * 
     * @throws Exception
     *             if the test fails.
    ...
    public void testBug69290() throws Exception {
        ...
        // MyAssert table types returned in getTableTypes()
        ...
        // MyAssert table types returned in getTables() for each catalog/schema
        for (int i = 0; i < testStepDescription.length; i++) {
            DatabaseMetaData testDbMetaData = testConnections[i].getMetaData();

            // MyAssert catalog/schema 'information_schema'
            ...
            // MyAssert catalog/schema 'performance_schema'
        ...
        // MyAssert table types returned in getTables() for all catalogs/schemas and filter by table type (tested with property nullCatalogMeansCurrent=false)
        for (int i = 0; i < testStepDescription.length; i++) {
            DatabaseMetaData testDbMetaData = testConnections[i].getMetaData();
            int j = 0;

            // MyAssert table type filters
    ...
    public void testBug21215151() throws Exception {
        ...
        // MyAssert the relative position of each element in the result set compared to the previous element.
        String previousDb = "";
        while (this.rs.next()) {
