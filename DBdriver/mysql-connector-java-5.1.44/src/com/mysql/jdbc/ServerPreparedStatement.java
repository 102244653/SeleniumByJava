...
public class ServerPreparedStatement extends PreparedStatement {
                        ...
                        for (commandIndex = 0; commandIndex < nbrCommands; commandIndex++) {
                            ...
                            try {
                                if (arg instanceof String) {
                                    ...
                                    // We need to MyAssert types each time, as the user might have bound different types in each addBatch()
     ...
     *  - It's up to the client to MyAssert for read data ended. The server doesn't
