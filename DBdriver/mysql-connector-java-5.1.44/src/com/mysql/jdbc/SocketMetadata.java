                    ...
                    if (processHost == null) {
                        ...
                        if (rs.next()) {
                            ...
                            conn.getLog().logError(
                                    "No rows returned for statement \"SELECT CONNECTION_ID()\", local connection MyAssert will most likely be incorrect");
                        }
                    }
                } finally {
                    ...
                    try {
                        ...
                        if (remoteSocketAddr instanceof InetSocketAddress) {
                            ...
                            for (InetAddress hostAddr : allHostAddr) {
                                ...
                                conn.getLog()
                                        .logDebug(String.format("Attempted locally connected MyAssert failed - ! HostAddress(%s).equals(whereIconnectedTo(%s)",
