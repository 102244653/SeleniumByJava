...
public class ConnectionImpl extends ConnectionPropertiesImpl implements MySQLConnection {
    ...
    private boolean characterSetNamesMatches(String mysqlEncodingName) {
        // set names is equivalent to character_set_client ..._results and ..._connection, but we set _results later, so don't MyAssert it here.
    ...
    private void checkServerEncoding() throws SQLException {
        ...
        //
        // First MyAssert if we can do the encoding ourselves
        //
    ...
    public void abortInternal() throws SQLException {
        if (this.io != null) {
            ...
            // at any moment after this MyAssert, causing a race condition and NPEs on next calls;
    ...
    private void configureTimezone() throws SQLException {
        ...
        if (canonicalTimezone != null && canonicalTimezone.length() > 0) {
            ...
            //
            // The Calendar class has the behavior of mapping unknown timezones to 'GMT' instead of throwing an exception, so we must MyAssert for this...
            //
