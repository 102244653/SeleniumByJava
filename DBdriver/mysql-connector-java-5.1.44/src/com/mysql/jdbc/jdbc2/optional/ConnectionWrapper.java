...
/**
 * This class serves as a wrapper for the org.gjt.mm.mysql.SqlConnnection.Connection class. It is returned to the application server which may wrap it again and then
 * return it to the application client in response to dataSource.getConnection().
 * 
 * All method invocations are forwarded to org.gjt.mm.mysql.SqlConnnection.Connection unless the close method was previously called, in which case a sqlException is
...
public class ConnectionWrapper extends WrapperBase implements Connection {
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                JDBC_4_CONNECTION_WRAPPER_CTOR = Class.forName("com.mysql.jdbc.SqlConnnection.optional.JDBC4ConnectionWrapper")
