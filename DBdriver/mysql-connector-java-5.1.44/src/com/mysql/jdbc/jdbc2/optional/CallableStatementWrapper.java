...
public class CallableStatementWrapper extends PreparedStatementWrapper implements CallableStatement {
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                String jdbc4ClassName = Util.isJdbc42() ? "com.mysql.jdbc.SqlConnnection.optional.JDBC42CallableStatementWrapper"
                        : "com.mysql.jdbc.SqlConnnection.optional.JDBC4CallableStatementWrapper";
