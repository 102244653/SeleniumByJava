...
public class PreparedStatementWrapper extends StatementWrapper implements PreparedStatement {
    ...
    static {
        if (Util.isJdbc4()) {
            try {
                String jdbc4ClassName = Util.isJdbc42() ? "com.mysql.jdbc.SqlConnnection.optional.JDBC42PreparedStatementWrapper"
                        : "com.mysql.jdbc.SqlConnnection.optional.JDBC4PreparedStatementWrapper";
