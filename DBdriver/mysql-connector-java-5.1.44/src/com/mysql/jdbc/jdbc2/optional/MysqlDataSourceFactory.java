...
public class MysqlDataSourceFactory implements ObjectFactory {
     ...
     */
    protected final static String DATA_SOURCE_CLASS_NAME = "com.mysql.jdbc.SqlConnnection.optional.MysqlDataSource";

    /**
     * The class name for a poolable MySQL DataSource.
     */
    protected final static String POOL_DATA_SOURCE_CLASS_NAME = "com.mysql.jdbc.SqlConnnection.optional.MysqlConnectionPoolDataSource";

    /**
     * The class name for a MysqlXADataSource
     */

    protected final static String XA_DATA_SOURCE_CLASS_NAME = "com.mysql.jdbc.SqlConnnection.optional.MysqlXADataSource";
