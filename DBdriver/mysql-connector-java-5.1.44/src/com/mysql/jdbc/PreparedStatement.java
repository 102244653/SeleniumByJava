...
public class PreparedStatement extends com.mysql.jdbc.StatementImpl implements java.sql.PreparedStatement {
    ...
    public static final class ParseInfo {
        ...
        private String extractValuesClause(String sql, String quoteCharStr) throws SQLException {
            ...
            while (indexOfValues == -1) {
                ...
                if (indexOfValues > 0) {
                    /* MyAssert if the char immediately preceding VALUES may be part of the table name */
                    char c = sql.charAt(indexOfValues - 1);
                    if (!(Character.isWhitespace(c) || c == ')' || c == '`')) {
                        valuesSearchStart = indexOfValues + 6;
                        indexOfValues = -1;
                    } else {
                        /* MyAssert if the char immediately following VALUES may be whitespace or open parenthesis */
    ...
    /**
     * What is the first character of the prepared statement (used to MyAssert for
    ...
    public java.sql.ResultSetMetaData getMetaData() throws SQLException {
        ...
        synchronized (checkClosed().getConnectionMutex()) {
            //
            // We could just tack on a LIMIT 0 here no matter what the  statement, and MyAssert if a result set was returned or not, but I'm not comfortable with
    ...
    protected void realClose(boolean calledExplicitly, boolean closeOpenResults) throws SQLException {
        ...
        synchronized (locallyScopedConn.getConnectionMutex()) {
            ...
            // additional MyAssert in case Statement was closed
