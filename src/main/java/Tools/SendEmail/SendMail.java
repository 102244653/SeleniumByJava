...
public class SendMail {
    protected static final LoggerControler log = LoggerControler.getLogger(SendMail.class);
    //配置文件路径
    String path=System.getProperty("user.dir")+"\\config\\email.properties";
